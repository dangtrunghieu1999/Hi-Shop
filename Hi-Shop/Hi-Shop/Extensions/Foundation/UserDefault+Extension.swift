...
public extension UserDefaults {
    ...
    func getObject<Value>(for key: UserDefaults.Key) -> Value? {
        let userDefaults = UserDefaults.standard
        return userDefaults.object(forKey: key.rawValue) as? Value
    }
    
    func getObjects<Value>(for key: UserDefaults.Key) -> [Value]? {
        let userDefaults = UserDefaults.standard
    ...
    func getCustomObject<Value: NSObject>(for key: UserDefaults.Key) -> Value? where Value: NSCoding {
        let userDefaults = UserDefaults.standard
    ...
    func setObject<Value>(for key: UserDefaults.Key, value: Value) {
        let userDefaults = UserDefaults.standard
        userDefaults.set(value, forKey: key.rawValue)
    }
    
    func setCustomObject<Value: NSObject>(for key: UserDefaults.Key, value: Value) where Value: NSCoding {
        let userDefaults = UserDefaults.standard

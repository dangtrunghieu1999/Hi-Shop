...
extension Notification.Name {
    ...
    static var reciveTokenMomo                          = Notification.Name("NoficationCenterTokenReceived")
    static var reloadLoginSuccess                       = Notification.Name("reloadLoginSuccess")
    static var reloadLoginGoogle                        = Notification.Name("reloadLoginGoogle")

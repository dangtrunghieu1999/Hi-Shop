...
class ProductCommentViewController: BaseViewController {
    ...
    override func touchUpInLeftBarButtonItem() {
        if isCheck == true {
            self.navigationController?.popToViewControllerType(NotificationViewController.self, completion: nil)
        } else {
...
extension ProductCommentViewController: SignInViewControllerDelegate {

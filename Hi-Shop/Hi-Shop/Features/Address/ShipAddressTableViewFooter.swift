...
protocol ShipAddressTableViewFooterDelegate: AnyObject {
    func didTapView()
}
...
class ShipAddressTableViewFooter: BaseTableViewHeaderFooter {
    ...
    fileprivate lazy var eventView: BaseView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(tapOnNewAddress))
    ...
    @objc private func tapOnNewAddress() {

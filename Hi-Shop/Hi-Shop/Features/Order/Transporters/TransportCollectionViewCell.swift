...
protocol TransportCollectionViewCellDelegate: AnyObject {
...
class TransportCollectionViewCell: BaseCollectionViewCell {
    ...
    weak var delegate: TransportCollectionViewCellDelegate?
...
extension TransportCollectionViewCell: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView,
        ...
        self.delegate?.didTapTransported(at: selectedTransporter ?? .giaoHangTietKiem)
        self.transporterTableView.reloadData()
    }
}

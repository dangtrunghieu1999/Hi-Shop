...
protocol PaymentCollectionViewCellDelegate: AnyObject {
...
class PaymentCollectionViewCell: BaseCollectionViewCell {
    ...
    weak var delegate: PaymentCollectionViewCellDelegate?
...
extension PaymentCollectionViewCell: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.delegate?.didTapPaymentMethod(at: selectedPayment ?? .cash)

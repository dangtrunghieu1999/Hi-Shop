...
class OrderCompleteViewController: BaseViewController {
    ...
    fileprivate lazy var logoImageView: UIImageView = {
        ...
        imageView.image = ImageManager.complete
    ...
    fileprivate lazy var usernameTitleLabel: UILabel = {
        let label = UILabel()
        if let fullName  = UserManager.user?.fullName {
            label.text = TextManager.thank + fullName
        } else {
            label.text = TextManager.thank
        }
    ...
    fileprivate lazy var orderSuccessLabel: UILabel = {
        let label = UILabel()
        label.text = TextManager.completeOrder
        label.textColor = UIColor.white
        label.textAlignment = .center
    ...
    fileprivate lazy var successImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = ImageManager.icon_success
        imageView.layer.masksToBounds = true

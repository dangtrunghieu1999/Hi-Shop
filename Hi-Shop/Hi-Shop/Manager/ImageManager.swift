...
final class ImageManager {
    ...
    static let imagePlaceHolder                     = UIImage(named: "white_background")
    ...
    static let icon_success                         = UIImage(named: "icon_success")
    ...
    // MARK: - Product
    static let icon_heart                           = UIImage(named: "icon_heart")
    static let icon_heartSelected                   = UIImage(named: "icon_heartSelected")
    ...
    static let filter                               = UIImage(named: "icon_filter")
    ...
    static let white_background                      = UIImage(named: "white_background")
    ...
    static let icon_setting                      = UIImage(named: "icon_setting")
    ...
    static let icon_ordered                      = UIImage(named: "icon_ordered")
    static let icon_address                      = UIImage(named: "icon_address")
    static let icon_transporter                  = UIImage(named: "icon_transporter")
    static let icon_payment                      = UIImage(named: "icon_payment")
    static let icon_package                      = UIImage(named: "icon_package")
    static let temp2                             = UIImage(named: "temp2")
}
